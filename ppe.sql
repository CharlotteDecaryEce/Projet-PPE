...
--
-- Host: 127.0.0.1:3306
-- Generation Time: Apr 08, 2019 at 10:17 AM
...
CREATE TABLE IF NOT EXISTS `informations` (
  ...
  `competences` set('Resolution de problemes','Confiance','Intelligence Emotionelle','Empathie','Communication','Gestion du temps','Gestion du stress','Creativite','Esprit d entreprendre','Audace','Motivation','Visualisation','Presence','Sens du collectif','Curiosite') NOT NULL,
...
('Thiroloix', 'Emmanuelle', '2018-06-06', '0676916066', 'F', 'ING4', 'France', 92300, '12 rue edouard vaillant', 'Etudiant(e) Licence', 'administrateur', 'user.png', '', 'Confiance,Empathie,Communication,Creativite,Audace,Motivation,Visualisation,Presence,Curiosite', '', '', '', 'manouel', 'manouel', 19, NULL, NULL, NULL, NULL, '');
